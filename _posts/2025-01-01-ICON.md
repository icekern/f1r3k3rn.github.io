...
```
### PERSONAGGIO - OUTCOME
![img.png](_general/loss_win_draw_distribution.png)

### KILLS / HEADSHOTS% AVG TIMELINE 
![img_1.png](_general/time_series_headshots_kills.png)

### DISTRIBUZIONI 

![img.png](_general/frequency_distribution_stats.png)
...
---
![pre_stats](_general/Distribuzione_delle_statistiche_pre.png)
...
![post_stats](_general/Distribuzione_delle_statistiche_post.png)
...
---
![win_loss_distribution](_general/win_loss_distribution_post.png)

---

![distribuzioni](_general/distribuzioni_post.png)
...
![bayesian_network](_general/bayes_structure.png)
...
![img.png](_general/rank_refactor.png)
